...
<head>
	...
	<link rel="stylesheet" href="{{ static_asset('assets/css/floating-wpp.min.css') }}">

    @if(\App\Language::where('code', Session::get('locale', Config::get('app.locale')))->first()->rtl == 1)
    <link rel="stylesheet" href="{{ static_asset('assets/css/bootstrap-rtl.min.css') }}">
	<link rel="stylesheet" href="{{ static_asset('assets/css/aiz-core.css') }}">
	<link rel="stylesheet" href="{{ static_asset('assets/css/custom-style-rtl-frontend.css') }}">
	@else
	<link rel="stylesheet" href="{{ static_asset('assets/css/aiz-core.css') }}">
...
<body>
	...
	@include('frontend.inc.frontend_sidebar')
...
{{--	<script src="{{ static_asset('assets/js/jquery-3.3.1.min.js') }}"> </script>--}}
	<script src="{{ static_asset('assets/js/floating-wpp.min.js') }}"> </script>
	@if(\App\Language::where('code', Session::get('locale', Config::get('app.locale')))->first()->rtl == 1)
	<script src="{{ static_asset('assets/js/custom-flat-icons-rtl.js') }}"> </script>
	@else
	<script src="{{ static_asset('assets/js/custom-flat-icons.js') }}"> </script>
	@endif
