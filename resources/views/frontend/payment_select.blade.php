                                ...
                                <div class="col-xxl-8 col-xl-10 mx-auto">
                                    <div class="row gutters-10">
                                        ...
                                        @if(\App\Addon::where('unique_identifier', 'african_pg')->first() != null && \App\Addon::where('unique_identifier', 'african_pg')->first()->activated)
                                            ...
                                            @endif
                                        @endif
                                            @if(get_setting('Moyasar_Payment') == 1)

                                                <div class="mysr-form"></div>
                                                <div class="col-6 col-md-4">
                                                    <label class="aiz-megabox d-block mb-3">
                                                        <input value="Moyasar_Payment" class="online_payment" type="radio" name="payment_option" checked>
                                                        <span class="d-block p-3 aiz-megabox-elem">
                                                        <img src="https://moyasar.com/docs/assets/images/moyasar.png" class="img-fluid mb-2">
                                                        <span class="d-block text-center">
                                                            <span class="d-block fw-600 fs-15">{{ translate('Moyasar_Payment')}}</span>
                                                        </span>
                                                    </span>
                                                    </label>
                                                </div>
