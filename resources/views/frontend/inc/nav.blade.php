...
<header class="@if(get_setting('header_stikcy') == 'on') sticky-top @endif z-1020 bg-white border-bottom shadow-sm">
    <div class="position-relative logo-bar-area z-1">
        <div class="container">
            <div class="d-flex align-items-center">
                ...
                <div class="col-3 d-lg-none col-xl-3 pl-0 pr-3 d-flex ">

					<div class="py-4 aiz-topbar-nav-toggler d-flex align-items-center justify-content-start mr-2 mr-md-3 d-lg-none" data-toggle="aiz-mobile-nav">
						<button class="aiz-mobile-toggler mm-nav mx-4">
							<span></span>
						</button>
					</div>
					...
					<div class="col-3 col-lg-auto col-xl-3 pl-0 pr-3 d-flex ">
                    <a class="py-4 d-block py-20px mr-3 ml-0" href="{{ route('home') }}">
                        @php
    ...
    @if ( get_setting('header_menu_labels') !=  null )
        <div class="d-none d-lg-block bg-white border-top border-gray-200 py-1">
            <div class="container">
                <ul class="list-inline mb-0 pl-0 mobile-hor-swipe text-center">
                    ...
                    <li class="list-inline-item mr-0">
                        <a href="{{ route('products.category', $category->slug) }}"  class="opacity-60 fs-14 px-3 py-2 d-inline-block fw-600 hov-opacity-100 text-reset">
