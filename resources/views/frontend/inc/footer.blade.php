                ...
                <div class="mt-4">
                    <a href="{{ route('home') }}" class="d-block">
                        @if(get_setting('footer_logo') != null)
                            <img style="width:300px" class="lazyload" src="{{ static_asset('assets/img/placeholder-rect.jpg') }}" data-src="{{ uploaded_asset(get_setting('footer_logo')) }}" alt="{{ env('APP_NAME') }}" height="44">
                        @else
                ...
                <div class="text-center text-md-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2">
                           ...
                           <span class="d-block opacity-70" dir="auto">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                <ul class="list-inline my-3 my-md-0 social colored text-center">
                    ...
                    @endif
                     @if ( get_setting('snabshat_link') !=  null )
                    <li class="list-inline-item">
                        <a href="{{ get_setting('snabshat_link') }}" target="_blank" class="snapchat"><i class="lab la-snapchat"></i></a>
                    </li>
                    @endif
                     @if ( get_setting('telegram_link') !=  null )
                    <li class="list-inline-item">
                        <a href="{{ get_setting('telegram_link') }}" target="_blank" class="twitter"><i class="lab la-telegram"></i></a>
                    </li>
                    @endif
{{--                     @if ( get_setting('tiktok_link') !=  null )--}}
{{--                    <li class="list-inline-item">--}}
{{--                        <a href="{{ get_setting('tiktok_link') }}" target="_blank" class="linkedin"><i class="lab la-linkedin-in"></i></a>--}}
{{--                    </li>--}}
{{--                    @endif--}}
