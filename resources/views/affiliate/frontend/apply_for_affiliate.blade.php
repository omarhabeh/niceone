...
{{--                                            <div class="form-group">--}}
{{--                                                <div class="input-group input-group--style-1">--}}
{{--                                                    <input type="text" class="form-control{{ $errors->has('country') ? ' is-invalid' : '' }}" value="{{ translate('Saudi Arabia') }}" placeholder="{{ translate('country') }}" name="country">--}}
{{--                                                    <span class="input-group-addon">--}}
...
{{--                                    </div>--}}
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <div class="input-group input-group--style-1">
                                                    <input type="text" class="form-control{{ $errors->has('city') ? ' is-invalid' : '' }}" value="{{ old('city') }}" placeholder="{{ translate('city') }}" name="city" required>
                                                    <span class="input-group-addon">
