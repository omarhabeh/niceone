                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group form-group">
                            ...
                            <input type="hidden" name="types[]" value="telegram_link">
                            <input type="text" class="form-control" placeholder="http://" name="telegram_link" value="{{ get_setting('telegram_link')}}">
                        </div>
                        <div class="input-group form-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="lab la-snapchat"></i></span>
                            </div>
                            <input type="hidden" name="types[]" value="snabshat_link">
                            <input type="text" class="form-control" placeholder="http://" name="snabshat_link" value="{{ get_setting('snabshat_link')}}">
                        </div>
{{--                        <div class="input-group form-group">--}}
{{--                            <div class="input-group-prepend">--}}
{{--                                <span class="input-group-text"><i class="lab la-"></i></span>--}}
{{--                            </div>--}}
{{--                            <input type="hidden" name="types[]" value="tiktok_link">--}}
{{--                            <input type="text" class="form-control" placeholder="http://" name="tiktok_link" value="{{ get_setting('tiktok_link')}}">--}}
{{--                        </div>--}}
