    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6">{{translate('Moyasar Payment')}}</h5>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="Moyasar_API_KEY">
                            <div class="col-lg-4">
                                <label class="col-from-label">{{translate('Moyasar API KEY')}}</label>
                            </div>
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="Moyasar_API_KEY" value="{{ get_setting('Moyasar_API_KEY') }}" placeholder="{{ translate('Moyasar API KEY') }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="Moyasar_SECRET_KEY" value="{{  get_setting('Moyasar_SECRET_KEY') }}" placeholder="{{ translate('Moyasar SECRET KEY') }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input value="1" name="Moyasar_sandbox" type="checkbox" @if (get_setting('Moyasar_sandbox') == 1)
                                        checked
                                    @endif>
                                    <span class="slider round"></span>
                                </label>
