    ...
    <div class="col-lg-4">
        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <h3 class="mb-0 h6 text-center">{{translate('Moyasar Payment')}}</h3>
            ...
            <div class="card-body text-center">
                ...
                <div class="clearfix">
                    ...
                    <img class="float-left" src="https://moyasar.com/docs/assets/images/moyasar.png" height="30">

                    <label class="aiz-switch aiz-switch-success mb-0 float-right">
                        <input type="checkbox" onchange="updateSettings(this, 'Moyasar_Payment')" <?php if(get_setting('Moyasar_Payment') == 1) echo "checked";?>>
                        <span class="slider round"></span>
