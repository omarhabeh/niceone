...
Route::post('/home/section/allCat', 'HomeController@load_cat_section')->name('home.section.allCat');
...
//moyasar
Route::get('/checkout/moyasar-order-confirmed', 'MoyasarController@MoyasarOrderConfirmed')->name('moyasar_order_confirmed');
