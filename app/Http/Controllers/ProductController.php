...
//            $val = $row->id . ' | ' . $row->name;
    ...
    public function store(Request $request)
    {
		...
		// ensure $locale is NOT NULL, and solve error when insert data
        ...
        $product_translation = ProductTranslation::firstOrNew(['lang' => $locale ,'id'=> $product->id]);
		$product_translation->lang = $locale;
